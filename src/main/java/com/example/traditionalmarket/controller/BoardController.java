...
public class BoardController {
    ...
    @PostMapping
    public ResponseEntity<ResponseDto<Void>> createBoard(@AuthenticatedUser User user, @RequestParam(name = "marketName") String marketName, @Valid @RequestBody CreateBoardDto createBoardDto) {
        boardService.createBoard(user, marketName, createBoardDto);
    ...
    public ResponseEntity<ResponseDto<Void>> updateBoard(@AuthenticatedUser User user, @PathVariable UUID boardId, @Valid @RequestBody UpdateBoardDto updateBoardDto) {
